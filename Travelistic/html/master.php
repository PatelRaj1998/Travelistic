...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar">
    ...
    <div class="w3-right w3-hide-small">
      <a onclick="post('hotels.php');" class="w3-bar-item w3-button"><i class='fas fa-hotel'></i> Hotels</a>
    </div>
    <div class="w3-right w3-hide-small">
...
<nav class="w3-sidebar w3-bar-block w3-black w3-card w3-animate-left w3-hide-medium w3-hide-large" style="display:none" id="mySidebar">
  ...
  <a onclick="w3_close(); post('hotels.php');" class="w3-bar-item w3-button">Hotels</a>
</nav>
...
<div class="w3-display-topright w3-text-white" style="padding:60px;">
    ...
    <input id="pac-input" class="controls" type="text" placeholder="Edit your destination" style="font-size: 15px;">
      ...
      <form action="master.php" method="post" id="placeBound">
        <input id="latitude" type="hidden" name="latitude" value="0">
        <input id="longitude" type="hidden" name="longitude" value="0">
      </form>
      
      <!-- Extra forms to send the location to each page -->
       <form action="food.php" method="POST" id="foodForm">
        <input id="latitude" type="hidden" name="latitude" value="0">
        <input id="longitude" type="hidden" name="longitude" value="0">
      </form>
       <form action="hotels.php" method="POST" id="hotelsForm">
        <input id="latitude" type="hidden" name="latitude" value="0">
        <input id="longitude" type="hidden" name="longitude" value="0">
      </form>
...
function initialize() {
  ...
  if (<?php echo isset($_POST['latitude']) ? 'true' : 'false'; ?>)
  {
  ...
  var request = {
    location: pyrmont,
    radius: '500',
    query: 'Restaurants, hotels, places to explore'
  };
...
<script src="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY&libraries=places&callback=initialize"
     async defer>
</script>
 </body>
</html>
